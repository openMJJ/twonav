...
<head>
	...
	<link rel="stylesheet" type="text/css" href="<?php echo $theme_dir?>/static/css/util.css">
	<link rel="stylesheet" type="text/css" href="<?php echo $theme_dir?>/static/css/main.css">
	...
	<div class="container-login100">
		<div class="wrap-login100">
			<form class="login100-form validate-form">
				<span class="login100-form-title"><?php echo $data['tip'];?></span>
				...
				<div class="text-center p-t-12">
					<a class="txt2" href="javascript:" onclick="showInfo('<?php echo base64_encode($data['get_tip'])?>')">
						如何获取？
					</a>
				</div>
				<?php }?>
				<div class="text-center p-t-30">
					<a class="txt2" href="./?u=<?php echo $u; ?>"><i class="fa fa-home m-l-5" aria-hidden="true"></i> 返回首页</a>
				</div>
			</form>
		</div>
	</div>
