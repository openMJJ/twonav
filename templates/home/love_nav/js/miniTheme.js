...
layui.define(["jquery", "layer"], function (exports) {
    ...
    var miniTheme = {
        ...
        render: function (options) {
            ...
            var bgcolorId = localStorage.getItem(u + '_love_nav_v1_bgid');
        ...
        buildBgColorHtml: function (options) {
            ...
            var bgcolorId = parseInt(localStorage.getItem(u + '_love_nav_v1_bgid'));
        ...
        listen: function (options) {
            ...
            $('body').on('click', '[data-select-bgcolor]', function () {
                ...
                localStorage.setItem(u + '_love_nav_v1_bgid', bgcolorId);
                miniTheme.render({
