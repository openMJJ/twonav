...
<html lang="zh-CN" element::-webkit-scrollbar {display:none}>
	<head>
		...
		<style>.change-type .showListType{width:<?php echo $theme_config['changewidth'];?>px;}</style>
    ...
    $(function(){
		...
		<div class="collapse navbar-collapse" id="navbarsExample05">
			<ul class="navbar-nav mr-auto">
				...
				<li class="nav-item"><a class="nav-link" href="./index.php?c=admin&u=<?php echo $u; ?>" target="_blank"><span><?php echo is_login ? '后台管理':'登录'; ?></span></a></li>
<?php if (is_apply()) { ?>
