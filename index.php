...
<?php } ?>
	...
	<ul class="mdui-list">
    	...
    	<a href="./index.php?c=guestbook&u=<?php echo $u?>" target="_blank">
			<li class="mdui-list-item mdui-ripple">
				<div class="mdui-list-item-content category-name" style="color: #FFD700;"><i class="fa fa-commenting-o"></i> 在线留言</div>
			</li>
		</a>
    	...
    	<a href="./index.php?c=apply&u=<?php echo $u?>" target="_blank">
			<li class="mdui-list-item mdui-ripple">
				<div class="mdui-list-item-content category-name" style="color: #FFD700;"><i class="fa fa-pencil"></i> 申请收录</div>
			</li>
		</a>
